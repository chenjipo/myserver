        ...
        $(this).each(function() {
            ...
            function update_position(e) {
                ...
                e.find(jQclass).each(function() {
                    ...
                    $(this).attr('data-dad-position', order);
                    order++
                    var game_id = $(this).find('.level_up').attr('data-id');

                    var change = $(this).attr('data-dad-position');
                    $.post("/?ct=platform&ac=changeSort",{game_id:game_id,sort:change});
            ...
            daddy.find(jq).on('mouseover touchstart',
                function(e) {
