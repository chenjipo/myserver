...
layui.define(function (e) {
  var a = layui.jquery,
    ...
    F = {
      ...
      sideFlexible: function (e) {
        ...
        'spread' === e
          ? (t.removeClass(x).addClass(g),
            n < 2 ? i.addClass(v) : i.removeClass(v),
            i.removeClass(C))
          : (t.removeClass(g).addClass(x),
            n < 2 ? i.removeClass(C) : i.addClass(C),
            i.removeClass(v)),
          layui.event.call(this, l.MOD_NAME, 'side({*})', { status: e })
      },
      escape: function (e) {
        return String(e || '')
          .replace(/&(?!#?[a-zA-Z0-9]+;)/g, '&amp;')
      ...
      popupRight: function (e) {
        return (F.popup.index = layer.open(
          a.extend(
            {
              type: 1,
              id: 'LAY_adminPopupR',
      ...
      initTheme: function (e) {
        var a = l.theme
        ;(e = e || 0),
          a.color[e] && ((a.color[e].index = e), F.theme({ color: a.color[e] }))
      },
      tabsPage: {},
      tabsBody: function (e) {
        return a(h)
      ...
      closeThisTabs: function () {
        F.tabsPage.index &&
          a(z).eq(F.tabsPage.index).find('.layui-tab-close').trigger('click')
      },
    },
    P = (F.events = {
      flexible: function (e) {
      ...
      fullscreen: function (e) {
        ...
        if (t.hasClass(a)) {
          ...
          l.webkitCancelFullScreen
            ...
            : l.cancelFullScreen
            ? l.cancelFullScreen()
            : l.exitFullscreen && l.exitFullscreen(),
      ...
      setTheme: function (e) {
        ...
        e.hasClass(y) ||
          (e.addClass(y).siblings('.layui-this').removeClass(y), F.initTheme(a))
      },
        ...
        'all' === e
          ? (a(z + ':gt(0)').remove(),
            a(h)
              .find('.' + b + ':gt(0)')
              .remove(),
            a(z).eq(0).trigger('click'))
          : (a(z).each(function (e, t) {
              e &&
                e != F.tabsPage.index &&
                (a(t).addClass(i), F.tabsBody(e).addClass(i))
            }),
            a('.' + i).remove())
      },
  ...
  !(function () {
    ...
    e.theme ? F.theme(e.theme) : l.theme && F.initTheme(l.theme.initColorIndex),
      ...
      l.pageTabs ||
        (a('#LAY_app_tabs').addClass(c), u.addClass('layadmin-tabspage-none')),
      s.ie &&
        s.ie < 10 &&
        n.error(
          'IE' +
    ...
    t.on('nav(layadmin-system-side-menu)', function (e) {
      e.siblings('.layui-nav-child')[0] &&
        u.hasClass(C) &&
        (F.sideFlexible('spread'), layer.close(e.data('index'))),
        (F.tabsPage.type = 'nav')
    }),
